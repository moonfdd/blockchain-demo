...
func TestSignRace(t *testing.T) {
	...
	for time.Now().Before(end) {
		if _, err := ks.SignHash(accounts.Account{Address: a1.Address}, testSigData); err == keystore.ErrLocked {
			return
		} else if err != nil {
...
// // finish in time
// func waitForKsUpdating(t *testing.T, ks *keystore.KeyStore, wantStatus bool, maxTime time.Duration) bool {
// 	t.Helper()
