...
import (
	...
	"github.com/moonfdd/blockchain-demo/examples/a003_btcd/b001_gen_interface_and_struct/mycore"
)
...
func BuildInterface(outPath string) {
	...
	if true {
		dir2 := `D:\mysetup\gopath\pkg\mod\github.com\btcsuite\btcd@v0.24.0`
		packageNamePrefix2 := `github.com/btcsuite/btcd`
		interfaceInfoList2, _ := mycore.LoadDir(dir2, packageNamePrefix2)
